...
class TestMergeUpsert:
    ...
    def test_upsert_writes_partitioned_inserts(self, temp_dir, duckdb_io):
        ...
        new_partition = dataset_path / "day=2025-01-02"
        assert list(new_partition.glob("*.parquet"))
        assert not list(dataset_path.glob("*.parquet"))
