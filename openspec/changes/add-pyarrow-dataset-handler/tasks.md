...
- [ ] 1.1 Create `PyarrowDatasetIO` class encapsulating existing PyArrow dataset functions (read/write/merge/compact/optimize where supported).
- [ ] 1.2 Add `PyarrowDatasetHandler` thin wrapper for convenience/backward compatibility; re-export from `fsspeckit.datasets`.
